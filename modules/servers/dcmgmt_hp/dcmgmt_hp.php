	...
	try {
		...
		switch($params['configoption1']) {
			case 'Null-route ip address': {
				...
				$output = shell_exec("python ".__DIR__."/lib/gateway.py --hwtype=hp-switch --routerip=".$params['serverip']." --username=".$params['serverusername']." --password=".$params['serverpassword']." --action=suspend --type=nullroute --customerip=".$params['customfields']['customerip']." 2>&1");
				break;
			}
			case 'Disable network port': {
				...
				$output = shell_exec("python ".__DIR__."/lib/gateway.py --hwtype=hp-switch --routerip=".$params['serverip']." --username=".$params['serverusername']." --password=".$params['serverpassword']." --action=suspend --type=shutdownport --interface=".$params['customfields']['interface']." 2>&1");
				break;
			}
		}
